...
export default class InputToolbar extends React.Component {
    constructor() {
        ...
        this.onGestureEvent = Animated.event([{ nativeEvent: { translationY: this.moveY } }], { useNativeDriver: true })
        this.state = {
            position: 'absolute',
        };
    ...
    render() {
        ...
        <PanGestureHandler 
                ...
                <Animated.View style={[styles.container,{ position: this.state.position},this.props.containerStyle,]}>
                    <Animated.View style={[styles.primary, this.props.primaryStyle]}> 
                        <View style={[{ flex: .75, flexDirection: 'row', borderRadius: 28, alignItems: 'center', marginLeft: widthPercentageToDP("2%")}, this.props.inputContainerStyle]}>
                        {this.renderComposer()}
                        {this.renderSend()}
                        </View>
